...
export default function AddVehicleForm() {
  ...
  const validateFormData = () => {
    ...
    if (marque.length < 2 || modele.length < 2) {
      throw new Error(
        "La marque et le modèle doivent contenir au moins 2 caractères."
      );
    }

    if (driver.length < 3) {
      throw new Error(
        "Le nom du chauffeur doit contenir au moins 3 caractères."
      );
    }
  };
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      <form onSubmit={handleSubmit}>
        ...
        <div className="bg-gray-100 p-6 rounded-lg mb-8">
          <Heading level="h3" className="px-4 mb-6 text-lg font-bold">
